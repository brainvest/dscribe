...
public class RichTextDocumentHandler : IRichTextDocumentHandler
{
	...
	public Task<byte[]> Process(byte[] input, Func<IEnumerable<string>, Task<Dictionary<string, string>>> valueExtractor)
	{
		// Method implementation is currently commented out.
