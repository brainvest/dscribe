            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EntityTypeFacetDefaultValues_EntityTypeFacetDefinitions_Fac~",
                        column: x => x.FacetDefinitionId,
                        principalTable: "EntityTypeFacetDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EntityTypeFacetDefaultValues_EntityTypeGeneralUsageCategori~",
                        column: x => x.GeneralUsageCategoryId,
                        principalTable: "EntityTypeGeneralUsageCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyFacetDefaultValues_PropertyFacetDefinitions_FacetDe~",
                        column: x => x.FacetDefinitionId,
                        principalTable: "PropertyFacetDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyFacetDefaultValues_PropertyGeneralUsageCategories_G~",
                        column: x => x.GeneralUsageCategoryId,
