...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Brainvest.Dscribe.MetadataDbAccess.Entities.AppInstance", b =>
                {
                    ...
                    b.Property<string>("DataConnectionStringTemplateName")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("LobConnectionStringTemplateName")
                        .HasColumnType("text");

                    b.Property<string>("LobDatabaseName")
                        .HasColumnType("text");

                    b.Property<string>("MainDatabaseName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Brainvest.Dscribe.MetadataDbAccess.Entities.AppInstance", b =>
                {
                    ...
                    b.Navigation("DatabaseProvider");

                    b.Navigation("MetadataRelease");
                });
            ...
            modelBuilder.Entity("Brainvest.Dscribe.MetadataDbAccess.Entities.EntityType", b =>
                {
                    ...
                    b.Navigation("BaseEntityType");

                    b.Navigation("GeneralUsageCategory");
                });
            ...
            modelBuilder.Entity("Brainvest.Dscribe.MetadataDbAccess.Entities.Property", b =>
                {
                    ...
                    b.Navigation("DataEntityType");

                    b.Navigation("DataType");

                    b.Navigation("ExpressionDefinition");

                    b.Navigation("ForeignKeyProperty");

                    b.Navigation("GeneralUsageCategory");

                    b.Navigation("InverseProperty");

                    b.Navigation("OwnerEntityType");
                });
            ...
            modelBuilder.Entity("Brainvest.Dscribe.MetadataDbAccess.Entities.PropertyBehavior", b =>
                {
                    ...
                    b.Navigation("AdditionalBehavior");
            ...
            modelBuilder.Entity("Brainvest.Dscribe.MetadataDbAccess.Entities.Property", b =>
                {
                    b.Navigation("PropertyBehaviors");

                    b.Navigation("PropertyFacetValues");

                    b.Navigation("Unused1");

                    b.Navigation("Unused2");
                });
