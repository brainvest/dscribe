...
{
	public class STuple<T1, T2, T3, T4, T5, T6> : IEquatable<STuple<T1, T2, T3, T4, T5, T6>>
	{
		...
		public bool Equals(STuple<T1, T2, T3, T4, T5, T6> b)
		{
			return b != null &&
		...
		{
			return (obj is STuple<T1, T2, T3, T4, T5, T6> b) && this.Equals(b);
		}
		...
		public static bool operator ==(STuple<T1, T2, T3, T4, T5, T6> a, STuple<T1, T2, T3, T4, T5, T6> b)
		{
			if (a == null)
			{
				return b == null;
