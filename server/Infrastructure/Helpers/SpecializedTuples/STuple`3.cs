...
{
	public class STuple<T1, T2, T3> : IEquatable<STuple<T1, T2, T3>>
	{
		public T1 Item1 { get; set; }
		public T2 Item2 { get; set; }
		public T3 Item3 { get; set; }

		public bool Equals(STuple<T1, T2, T3> b)
		{
			return b != null &&
		...
		{
			return (obj is STuple<T1, T2, T3> b) && this.Equals(b);
		}
		...
		public static bool operator ==(STuple<T1, T2, T3> a, STuple<T1, T2, T3> b)
		{
			if (a == null)
			{
				return b == null;
